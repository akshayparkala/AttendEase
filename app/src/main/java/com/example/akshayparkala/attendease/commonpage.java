...
public class View implements Drawable.Callback, KeyEvent.Callback,
     ...
     */
    private int mLabelForId = android.view.View.NO_ID;
     ...
     * the user may specify which view to go to next.
     */
    int mNextFocusForwardId = android.view.View.NO_ID;
     ...
     * {@link #startDragAndDrop(ClipData, android.view.View.DragShadowBuilder, Object, int)} is called
    ...
    private static class DeclaredOnClickListener implements android.view.View.OnClickListener {
        ...
        public DeclaredOnClickListener(@NonNull android.view.View hostView, @NonNull String methodName) {
            mHostView = hostView;
        ...
        private void resolveMethod(@Nullable Context context, @NonNull String name) {
            while (context != null) {
                try {
                    if (!context.isRestricted()) {
                        final Method method = context.getClass().getMethod(mMethodName, android.view.View.class);
                        if (method != null) {
    ...
    public void addOnLayoutChangeListener(android.view.View.OnLayoutChangeListener listener) {
        ...
        if (li.mOnLayoutChangeListeners == null) {
            li.mOnLayoutChangeListeners = new ArrayList<android.view.View.OnLayoutChangeListener>();
        }
     ...
     * @see #removeOnAttachStateChangeListener(android.view.View.OnAttachStateChangeListener)
     */
    public void addOnAttachStateChangeListener(android.view.View.OnAttachStateChangeListener listener) {
        ListenerInfo li = getListenerInfo();
        if (li.mOnAttachStateChangeListeners == null) {
            li.mOnAttachStateChangeListeners
                    = new CopyOnWriteArrayList<android.view.View.OnAttachStateChangeListener>();
        }
     ...
     * @see #addOnAttachStateChangeListener(android.view.View.OnAttachStateChangeListener)
     */
     ...
     */
    public void setOnLongClickListener(@Nullable android.view.View.OnLongClickListener l) {
        if (!isLongClickable()) {
     ...
     */
    public void setOnContextClickListener(@Nullable android.view.View.OnContextClickListener l) {
    ...
    public boolean performContextClick() {
        ...
        if (li != null && li.mOnContextClickListener != null) {
            handled = li.mOnContextClickListener.onContextClick(android.view.View.this);
        }
        if (handled) {
     ...
     * {@link android.view.View.OnDragListener#onDrag(android.view.View, DragEvent)} method.
     ...
     *
     * Note: this does not check whether this {@link android.view.View} should get focus, it just
     * gives it focus no matter what.  It should only be called internally by framework
     * code that knows what it is doing, namely {@link #requestFocus(int, Rect)}.
     *
     * @param direction values are {@link android.view.View#FOCUS_UP}, {@link android.view.View#FOCUS_DOWN},
     *        {@link android.view.View#FOCUS_LEFT} or {@link android.view.View#FOCUS_RIGHT}. This is the direction which
    ...
    void handleFocusGainInternal(@FocusRealDirection int direction, Rect previouslyFocusedRect) {
        ...
        if ((mPrivateFlags & PFLAG_FOCUSED) == 0) {
            ...
            android.view.View oldFocus = (mAttachInfo != null) ? getRootView().findFocus() : null;
     ...
     * views responding to a focus change in {@link ViewParent#requestChildFocus(android.view.View, android.view.View)}
     ...
     */
    void clearFocusInternal(android.view.View focused, boolean propagate, boolean refocus) {
        if ((mPrivateFlags & PFLAG_FOCUSED) != 0) {
            mPrivateFlags &= ~PFLAG_FOCUSED;
    ...
    void notifyGlobalFocusCleared(android.view.View oldFocus) {
    ...
    boolean rootViewRequestFocus() {
        final android.view.View root = getRootView();
     ...
     * and last calls
     * {@link ViewParent#requestSendAccessibilityEvent(android.view.View, AccessibilityEvent)}
     ...
     * {@link android.view.View.AccessibilityDelegate#sendAccessibilityEvent(android.view.View, int)} is
     ...
     * @see ViewParent#requestSendAccessibilityEvent(android.view.View, AccessibilityEvent)
     ...
     *
     * Note: Called from the default {@link android.view.View.AccessibilityDelegate}.
     *
     * @hide
     */
     ...
     * If an {@link android.view.View.AccessibilityDelegate} has been specified via calling
     * {@link #setAccessibilityDelegate(android.view.View.AccessibilityDelegate)} its
     * {@link android.view.View.AccessibilityDelegate#sendAccessibilityEventUnchecked(android.view.View, AccessibilityEvent)}
    ...
    /**
     * Dispatches an {@link AccessibilityEvent} to the {@link android.view.View} first and then
     ...
     * If an {@link android.view.View.AccessibilityDelegate} has been specified via calling
     * {@link #setAccessibilityDelegate(android.view.View.AccessibilityDelegate)} its
     * {@link android.view.View.AccessibilityDelegate#dispatchPopulateAccessibilityEvent(android.view.View, AccessibilityEvent)}
     * is responsible for handling this call.
     * </p>
     * <p>
     ...
     * If an {@link android.view.View.AccessibilityDelegate} has been specified via calling
     * {@link #setAccessibilityDelegate(android.view.View.AccessibilityDelegate)} its
     * {@link android.view.View.AccessibilityDelegate#onPopulateAccessibilityEvent(android.view.View, AccessibilityEvent)}
     * is responsible for handling this call.
     * </p>
     ...
     * If an {@link android.view.View.AccessibilityDelegate} has been specified via calling
     * {@link #setAccessibilityDelegate(android.view.View.AccessibilityDelegate)} its
     * {@link android.view.View.AccessibilityDelegate#onInitializeAccessibilityEvent(android.view.View, AccessibilityEvent)}
     * is responsible for handling this call.
     * </p>
     * <p class="note"><strong>Note:</strong> Always call the super implementation before adding
     * information to the event, in case the default implementation has basic information to add.
    ...
    public void onInitializeAccessibilityEventInternal(AccessibilityEvent event) {
        ...
        switch (event.getEventType()) {
            case AccessibilityEvent.TYPE_VIEW_FOCUSED: {
                ArrayList<android.view.View> focusablesTempList = (mAttachInfo != null)
                        ? mAttachInfo.mTempArrayList : new ArrayList<android.view.View>();
                getRootView().addFocusables(focusablesTempList, android.view.View.FOCUS_FORWARD, FOCUSABLES_ALL);
     ...
     * <ul>
     *   <li>{@link AccessibilityNodeInfo#setParent(android.view.View)},</li>
     ...
     * If an {@link android.view.View.AccessibilityDelegate} has been specified via calling
     * {@link #setAccessibilityDelegate(android.view.View.AccessibilityDelegate)} its
     * {@link android.view.View.AccessibilityDelegate#onInitializeAccessibilityNodeInfo(android.view.View, AccessibilityNodeInfo)}
     * is responsible for handling this call.
     * </p>
     *
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo info) {
        ...
        if (mID != android.view.View.NO_ID) {
            ...
            android.view.View label = rootView.findLabelForView(this, mID);
            if (label != null) {
        ...
        if (mLabelForId != android.view.View.NO_ID) {
            android.view.View rootView = getRootView();
            if (rootView == null) {
                rootView = this;
            }
            android.view.View labeled = rootView.findViewInsideOutShouldExist(this, mLabelForId);
            if (labeled != null) {
                info.setLabelFor(labeled);
            }
        }

        if (mAccessibilityTraversalBeforeId != android.view.View.NO_ID) {
            android.view.View rootView = getRootView();
            if (rootView == null) {
                rootView = this;
            }
            android.view.View next = rootView.findViewInsideOutShouldExist(this,
        ...
        if (mAccessibilityTraversalAfterId != android.view.View.NO_ID) {
            android.view.View rootView = getRootView();
            if (rootView == null) {
                rootView = this;
            }
    ...
    private void populateAccessibilityNodeInfoDrawingOrderInParent(AccessibilityNodeInfo info) {
        ...
        android.view.View viewAtDrawingLevel = this;
        ...
        while (viewAtDrawingLevel != parent) {
            ...
            if (!(currentParent instanceof ViewGroup)) {
                ...
                if (childCount > 1) {
                    List<android.view.View> preorderedList = parentGroup.buildOrderedChildList();
            ...
            viewAtDrawingLevel = (android.view.View) currentParent;
        }
    ...
    private android.view.View findLabelForView(android.view.View view, int labeledId) {
     ...
     * composition. For more details see {@link android.view.View.AccessibilityDelegate}.
     *
     ...
     * @see android.view.View.AccessibilityDelegate
     */
    public void setAccessibilityDelegate(@Nullable android.view.View.AccessibilityDelegate delegate) {
     ...
     * If an {@link android.view.View.AccessibilityDelegate} has been specified via calling
     * {@link #setAccessibilityDelegate(android.view.View.AccessibilityDelegate)} its
     * {@link android.view.View.AccessibilityDelegate#getAccessibilityNodeProvider(android.view.View)}
     * is responsible for handling this call.
     * </p>
     *
     * @return The provider.
     ...
     * If this {@link android.view.View} is not attached to any window, {@value #NO_ID} is returned.
     *
    ...
    /**
     * Returns the {@link android.view.View}'s content description.
     * <p>
    ...
    /**
     * Sets the {@link android.view.View}'s content description.
     * <p>
     ...
     *
     * <p>Clients may supply an {@link android.view.View.OnApplyWindowInsetsListener} to a view. If one is set
    ...
    /**
     * Set an {@link android.view.View.OnApplyWindowInsetsListener} to take over the policy for applying
     * window insets to this view. The listener's
     * {@link android.view.View.OnApplyWindowInsetsListener#onApplyWindowInsets(android.view.View, WindowInsets) onApplyWindowInsets}
     ...
     * {@link android.view.View.OnApplyWindowInsetsListener} via the
     ...
     *         can be found.
     */
    public android.view.View focusSearch(@FocusRealDirection int direction) {
        if (mParent != null) {
     ...
     */
    public boolean dispatchUnhandledMove(android.view.View focused, @FocusRealDirection int direction) {
        return false;
    }
     ...
     */
    android.view.View findUserSetNextFocus(android.view.View root, @FocusDirection int direction) {
        switch (direction) {
            case FOCUS_LEFT:
                if (mNextFocusLeftId == android.view.View.NO_ID) return null;
                return findViewInsideOutShouldExist(root, mNextFocusLeftId);
            case FOCUS_RIGHT:
                if (mNextFocusRightId == android.view.View.NO_ID) return null;
                return findViewInsideOutShouldExist(root, mNextFocusRightId);
            case FOCUS_UP:
                if (mNextFocusUpId == android.view.View.NO_ID) return null;
                return findViewInsideOutShouldExist(root, mNextFocusUpId);
            case FOCUS_DOWN:
                if (mNextFocusDownId == android.view.View.NO_ID) return null;
                return findViewInsideOutShouldExist(root, mNextFocusDownId);
            case FOCUS_FORWARD:
                if (mNextFocusForwardId == android.view.View.NO_ID) return null;
                return findViewInsideOutShouldExist(root, mNextFocusForwardId);
            case FOCUS_BACKWARD: {
                if (mID == android.view.View.NO_ID) return null;
                final int id = mID;
                return root.findViewByPredicateInsideOut(this, new Predicate<android.view.View>() {
                    @Override
                    public boolean apply(android.view.View t) {
    ...
    private android.view.View findViewInsideOutShouldExist(android.view.View root, int id) {
        if (mMatchIdPredicate == null) {
            mMatchIdPredicate = new MatchIdPredicate();
        }
        mMatchIdPredicate.mId = id;
        android.view.View result = root.findViewByPredicateInsideOut(this, mMatchIdPredicate);
        if (result == null) {
     ...
     */
    public ArrayList<android.view.View> getFocusables(@FocusDirection int direction) {
        ArrayList<android.view.View> result = new ArrayList<android.view.View>(24);
     ...
     * @param direction The direction of the focus
     */
    public void addFocusables(ArrayList<android.view.View> views, @FocusDirection int direction) {
     ...
     * @see #setContentDescription(CharSequence)
     */
    public void findViewsWithText(ArrayList<android.view.View> outViews, CharSequence searched,
     ...
     */
    public ArrayList<android.view.View> getTouchables() {
        ArrayList<android.view.View> result = new ArrayList<android.view.View>();
    ...
    private void sendAccessibilityHoverEvent(int eventType) {
        ...
        while (true) {
            ...
            if (parent instanceof android.view.View) {
                source = (android.view.View) parent;
            } else {
                return;
            }
        }
     ...
     * have focus, and you want your parent to look for the next one.
     *
     * You may wish to override this method if your custom {@link android.view.View} has an internal
     * {@link android.view.View} that it wishes to forward the request to.
     *
     * @param direction One of FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, and FOCUS_RIGHT
    ...
    public void setImportantForAccessibility(int mode) {
        ...
        if (mode != oldMode) {
            ...
            if (mode == IMPORTANT_FOR_ACCESSIBILITY_NO || hideDescendants) {
                final android.view.View focusHost = findAccessibilityFocusHost(hideDescendants);
                if (focusHost != null) {
     ...
     */
    private android.view.View findAccessibilityFocusHost(boolean searchDescendants) {
        ...
        if (searchDescendants) {
            ...
            if (viewRoot != null) {
                final android.view.View focusHost = viewRoot.getAccessibilityFocusedHost();
                if (focusHost != null && ViewRootImpl.isViewDescendantOf(focusHost, this)) {
                    return focusHost;
                }
            }
     ...
     * <li>Has an {@link android.view.View.AccessibilityDelegate}
     * <li>Has an interaction listener, e.g. {@link android.view.View.OnTouchListener},
     * {@link android.view.View.OnKeyListener}, etc.
    ...
    public boolean isImportantForAccessibility() {
        ...
        ViewParent parent = mParent;
        while (parent instanceof android.view.View) {
            if (((android.view.View) parent).getImportantForAccessibility()
                    == IMPORTANT_FOR_ACCESSIBILITY_NO_HIDE_DESCENDANTS) {
                return false;
            }
    ...
    public ViewParent getParentForAccessibility() {
        if (mParent instanceof android.view.View) {
            android.view.View parentView = (android.view.View) mParent;
     ...
     */
    public void addChildrenForAccessibility(ArrayList<android.view.View> outChildren) {
    ...
    public void setTransitionVisibility(@Visibility int visibility) {
        mViewFlags = (mViewFlags & ~android.view.View.VISIBILITY_MASK) | visibility;
    }
     ...
     * {@link ViewParent#onNestedPrePerformAccessibilityAction(android.view.View, int, android.os.Bundle)}
     ...
     * If an {@link android.view.View.AccessibilityDelegate} has been specified via calling
     * {@link #setAccessibilityDelegate(android.view.View.AccessibilityDelegate)} its
     * {@link android.view.View.AccessibilityDelegate#performAccessibilityAction(android.view.View, int, Bundle)}
     * is responsible for handling this call.
     * </p>
     *
    ...
    /**
     * Tells whether the {@link android.view.View} is in the state between {@link #onStartTemporaryDetach()}
     ...
     * {@link ViewGroup#detachViewFromParent(android.view.View) ViewGroup.detachViewFromParent}.
     ...
     */
    protected void dispatchVisibilityChanged(@NonNull android.view.View changedView,
     ...
     *                   {@link #INVISIBLE} or {@link #GONE}.
     */
    protected void onVisibilityChanged(@NonNull android.view.View changedView, @Visibility int visibility) {
    }
     ...
     * {@link android.view.View.OnCreateContextMenuListener} to add items to the context menu.
     *
     ...
     * the {@link android.view.View.OnCreateContextMenuListener#onCreateContextMenu(ContextMenu, android.view.View, ContextMenu.ContextMenuInfo)}
     * callback.
     *
     ...
     * {@link android.view.View#invalidate()} on the view's parent to force the parent to redraw
     * with the new child ordering.
     *
     * @see ViewGroup#bringChildToFront(android.view.View)
     */
     ...
     * to listen for changes in list scroll position.
     *
     * @see #setOnScrollChangeListener(android.view.View.OnScrollChangeListener)
     */
     ...
     * Circular clips from a {@link ViewAnimationUtils#createCircularReveal(android.view.View, int, int, float, float)
    ...
    private android.view.View getProjectionReceiver() {
        ViewParent p = getParent();
        while (p != null && p instanceof android.view.View) {
            final android.view.View v = (android.view.View) p;
    ...
    protected void invalidateParentCaches() {
        if (mParent instanceof android.view.View) {
            ((android.view.View) mParent).mPrivateFlags |= PFLAG_INVALIDATED;
        }
    }
    ...
    protected void invalidateParentIfNeeded() {
        if (isHardwareAccelerated() && mParent instanceof android.view.View) {
            ((android.view.View) mParent).invalidate(true);
        }
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        if (mStartActivityRequestWho != null) {
            android.view.View.BaseSavedState state = new android.view.View.BaseSavedState(AbsSavedState.EMPTY_STATE);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if (state != null && state instanceof android.view.View.BaseSavedState) {
            mStartActivityRequestWho = ((android.view.View.BaseSavedState) state).mStartActivityRequestWhoSaved;
        }
    }
    ...
    public void outputDirtyFlags(String indent, boolean clear, int clearMask) {
        Log.d("View", indent + this + "             DIRTY(" + (mPrivateFlags & android.view.View.PFLAG_DIRTY_MASK) +
    ...
    private boolean setOpticalFrame(int left, int top, int right, int bottom) {
        Insets parentInsets = mParent instanceof android.view.View ?
                ((android.view.View) mParent).getOpticalInsets() : Insets.NONE;
     ...
     *
     * Will call {@link android.view.View#onResolveDrawables} when resolution is done.
     *
     * @hide
     */
    protected void resolveDrawables() {
        ...
        if (!isLayoutDirectionResolved() &&
                getRawLayoutDirection() == android.view.View.LAYOUT_DIRECTION_INHERIT) {
            return;
        }
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        if ((mViewFlags & DUPLICATE_PARENT_STATE) == DUPLICATE_PARENT_STATE &&
                mParent instanceof android.view.View) {
    ...
    public android.view.View getRootView() {
        if (mAttachInfo != null) {
            final android.view.View v = mAttachInfo.mRootView;
            if (v != null) {
                return v;
            }
        }
        ...
        while (parent.mParent != null && parent.mParent instanceof android.view.View) {
     ...
     */
    protected android.view.View findViewTraversal(@IdRes int id) {
        if (id == mID) {
            return this;
        }
        return null;
     ...
     */
    protected android.view.View findViewWithTagTraversal(Object tag) {
     ...
     */
    protected android.view.View findViewByPredicateTraversal(Predicate<android.view.View> predicate, android.view.View childToSkip) {
     ...
     */
    @Nullable
    public final android.view.View findViewById(@IdRes int id) {
        if (id < 0) {
            return null;
        }
     ...
     */
    final android.view.View findViewByAccessibilityId(int accessibilityId) {
        if (accessibilityId < 0) {
            return null;
        }
        android.view.View view = findViewByAccessibilityIdTraversal(accessibilityId);
        if (view != null) {
     ...
     */
    public final android.view.View findViewWithTag(Object tag) {
        if (tag == null) {
            return null;
        }
     ...
     * @return The first view that matches the predicate or null.
     */
    public final android.view.View findViewByPredicate(Predicate<android.view.View> predicate) {
     ...
     * @return The first view that matches the predicate or null.
     */
    public final android.view.View findViewByPredicateInsideOut(android.view.View start, Predicate<android.view.View> predicate) {
    ...
    public void setId(@IdRes int id) {
        mID = id;
        if (mID == android.view.View.NO_ID && mLabelForId != android.view.View.NO_ID) {
            mID = generateViewId();
        }
    }
     ...
     * @param l  The {@link android.view.View.OnSystemUiVisibilityChangeListener} to receive callbacks.
     */
    ...
    public static class DragShadowBuilder {
        private final WeakReference<android.view.View> mView;
        ...
        public DragShadowBuilder(android.view.View view) {
            mView = new WeakReference<android.view.View>(view);
        }
        ...
        public DragShadowBuilder() {
            mView = new WeakReference<android.view.View>(null);
        }
        ...
        final public android.view.View getView() {
            return mView.get();
        }
        ...
        public void onProvideShadowMetrics(Point outShadowSize, Point outShadowTouchPoint) {
            final android.view.View view = mView.get();
            if (view != null) {
                outShadowSize.set(view.getWidth(), view.getHeight());
                outShadowTouchPoint.set(outShadowSize.x / 2, outShadowSize.y / 2);
            } else {
                Log.e(android.view.View.VIEW_LOG_TAG, "Asked for drag thumb metrics but no view");
            }
        }
        ...
        public void onDrawShadow(Canvas canvas) {
            ...
            if (view != null) {
                ...
                Log.e(android.view.View.VIEW_LOG_TAG, "Asked to draw drag shadow but no view");
            }
        }
    }

    /**
     * @deprecated Use {@link #startDragAndDrop(ClipData, android.view.View.DragShadowBuilder, Object, int)
     * startDragAndDrop()} for newer platform versions.
     */
    public final boolean startDrag(ClipData data, android.view.View.DragShadowBuilder shadowBuilder,
     ...
     * system calls this object's {@link android.view.View.DragShadowBuilder#onProvideShadowMetrics(Point, Point)}
     * to get metrics for the drag shadow, and then calls the object's
     * {@link android.view.View.DragShadowBuilder#onDrawShadow(Canvas)} to draw the drag shadow itself.
     * <p>
     *  Once the system has the drag shadow, it begins the drag and drop operation by sending
     *  drag events to all the View objects in your application that are currently visible. It does
     *  this either by calling the View object's drag listener (an implementation of
     *  {@link android.view.View.OnDragListener#onDrag(android.view.View,DragEvent) onDrag()} or by calling the
     ...
     * </p>
     * <p>
     * Your application can invoke {@link #startDragAndDrop(ClipData, android.view.View.DragShadowBuilder, Object,
     ...
     */
    public final boolean startDragAndDrop(ClipData data, android.view.View.DragShadowBuilder shadowBuilder,
                                          Object myLocalState, int flags) {
     ...
     * {@link #startDragAndDrop(ClipData, android.view.View.DragShadowBuilder, Object, int) startDragAndDrop}
     * was called.
     * </p>
     */
     ...
     * new drag shadow.
     */
    public final void updateDragShadow(android.view.View.DragShadowBuilder shadowBuilder) {
        if (ViewDebug.DEBUG_DRAG) {
     ...
     * {@link android.view.View#startDragAndDrop(ClipData, android.view.View.DragShadowBuilder,Object,int)
     * startDragAndDrop()}.
     *<p>
    ...
    final boolean callDragEventHandler(DragEvent event) {
        ...
        switch (event.mAction) {
            case DragEvent.ACTION_DRAG_ENTERED: {
                mPrivateFlags2 |= android.view.View.PFLAG2_DRAG_HOVERED;
                refreshDrawableState();
            } break;
            ...
            case DragEvent.ACTION_DRAG_ENDED: {
                mPrivateFlags2 &= ~android.view.View.DRAG_MASK;
                refreshDrawableState();
            } break;
        }
     ...
     * @see LayoutInflater
     */
    public static android.view.View inflate(Context context, @LayoutRes int resource, ViewGroup root) {
     ...
     * these values differently. See {@link ViewParent#onNestedScroll(android.view.View, int, int, int, int)}.
     * </p>
     *
     ...
     * @hide
     */
    public void captureTransitioningViews(List<android.view.View> transitioningViews) {
     ...
     * @hide
     */
    public void findNamedViews(Map<String, android.view.View> namedElements) {
     ...
     * {@link android.view.View#setAlpha(float)} and {@link android.view.View#getAlpha()} methods.
     */
    public static final Property<android.view.View, Float> ALPHA = new FloatProperty<android.view.View>("alpha") {
        @Override
        public void setValue(android.view.View object, float value) {
            object.setAlpha(value);
        }

        @Override
        public Float get(android.view.View object) {
     ...
     * {@link android.view.View#setTranslationX(float)} and {@link android.view.View#getTranslationX()} methods.
     */
    public static final Property<android.view.View, Float> TRANSLATION_X = new FloatProperty<android.view.View>("translationX") {
        @Override
        public void setValue(android.view.View object, float value) {
     ...
     * {@link android.view.View#setTranslationY(float)} and {@link android.view.View#getTranslationY()} methods.
     */
    public static final Property<android.view.View, Float> TRANSLATION_Y = new FloatProperty<android.view.View>("translationY") {
        @Override
        public void setValue(android.view.View object, float value) {
     ...
     * {@link android.view.View#setTranslationZ(float)} and {@link android.view.View#getTranslationZ()} methods.
     */
    public static final Property<android.view.View, Float> TRANSLATION_Z = new FloatProperty<android.view.View>("translationZ") {
        @Override
        public void setValue(android.view.View object, float value) {
     ...
     * {@link android.view.View#setX(float)} and {@link android.view.View#getX()} methods.
     */
    public static final Property<android.view.View, Float> X = new FloatProperty<android.view.View>("x") {
        @Override
        public void setValue(android.view.View object, float value) {
            object.setX(value);
        }
     ...
     * {@link android.view.View#setY(float)} and {@link android.view.View#getY()} methods.
     */
    public static final Property<android.view.View, Float> Y = new FloatProperty<android.view.View>("y") {
        @Override
        public void setValue(android.view.View object, float value) {
            object.setY(value);
        }
     ...
     * {@link android.view.View#setZ(float)} and {@link android.view.View#getZ()} methods.
     */
    public static final Property<android.view.View, Float> Z = new FloatProperty<android.view.View>("z") {
        @Override
        public void setValue(android.view.View object, float value) {
            object.setZ(value);
        }
     ...
     * {@link android.view.View#setRotation(float)} and {@link android.view.View#getRotation()} methods.
     */
    public static final Property<android.view.View, Float> ROTATION = new FloatProperty<android.view.View>("rotation") {
        @Override
        public void setValue(android.view.View object, float value) {
     ...
     * {@link android.view.View#setRotationX(float)} and {@link android.view.View#getRotationX()} methods.
     */
    public static final Property<android.view.View, Float> ROTATION_X = new FloatProperty<android.view.View>("rotationX") {
        @Override
        public void setValue(android.view.View object, float value) {
     ...
     * {@link android.view.View#setRotationY(float)} and {@link android.view.View#getRotationY()} methods.
     */
    public static final Property<android.view.View, Float> ROTATION_Y = new FloatProperty<android.view.View>("rotationY") {
        @Override
        public void setValue(android.view.View object, float value) {
     ...
     * {@link android.view.View#setScaleX(float)} and {@link android.view.View#getScaleX()} methods.
     */
    public static final Property<android.view.View, Float> SCALE_X = new FloatProperty<android.view.View>("scaleX") {
        @Override
        public void setValue(android.view.View object, float value) {
     ...
     * {@link android.view.View#setScaleY(float)} and {@link android.view.View#getScaleY()} methods.
     */
    public static final Property<android.view.View, Float> SCALE_Y = new FloatProperty<android.view.View>("scaleY") {
        @Override
        public void setValue(android.view.View object, float value) {
    ...
    public interface OnKeyListener {
         ...
         */
        boolean onKey(android.view.View v, int keyCode, KeyEvent event);
    }
    ...
    public interface OnHoverListener {
         ...
         * @return True if the listener has consumed the event, false otherwise.
         */
        boolean onHover(android.view.View v, MotionEvent event);
    }
    ...
    public interface OnGenericMotionListener {
         ...
         * @return True if the listener has consumed the event, false otherwise.
         */
        boolean onGenericMotion(android.view.View v, MotionEvent event);
    }
    ...
    public interface OnDragListener {
         ...
         */
        boolean onDrag(android.view.View v, DragEvent event);
    }
    ...
    public interface OnContextClickListener {
         ...
         */
        boolean onContextClick(android.view.View v);
    }
    ...
    public interface OnCreateContextMenuListener {
         ...
         */
        void onCreateContextMenu(ContextMenu menu, android.view.View v, ContextMenu.ContextMenuInfo menuInfo);
    }
    ...
    public interface OnApplyWindowInsetsListener {
        /**
         * When {@link android.view.View#setOnApplyWindowInsetsListener(android.view.View.OnApplyWindowInsetsListener) set}
         * on a View, this listener method will be called instead of the view's own
         * {@link android.view.View#onApplyWindowInsets(WindowInsets) onApplyWindowInsets} method.
         *
    ...
    public static class BaseSavedState extends AbsSavedState {
        ...
        public static final Parcelable.Creator<android.view.View.BaseSavedState> CREATOR
                = new Parcelable.ClassLoaderCreator<android.view.View.BaseSavedState>() {
            @Override
            public android.view.View.BaseSavedState createFromParcel(Parcel in) {
                return new android.view.View.BaseSavedState(in);
            }

            @Override
            public android.view.View.BaseSavedState createFromParcel(Parcel in, ClassLoader loader) {
                return new android.view.View.BaseSavedState(in, loader);
            }
    ...
    private static class ScrollabilityCache implements Runnable {
        ...
        public ScrollabilityCache(ViewConfiguration configuration, android.view.View host) {
    ...
    /**
     * <p>
     * This class represents a delegate that can be registered in a {@link android.view.View}
     ...
     * {@link android.view.View#onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo)} is not available
     ...
     * {@link android.view.View#onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo)}.
     * </p>
     * <p>
    ...
    public static class AccessibilityDelegate {
         ...
         * <p>
         * The default implementation behaves as {@link android.view.View#sendAccessibilityEvent(int)
         ...
         * {@link android.view.View#performAccessibilityAction(int, Bundle)
         ...
         */
        public boolean performAccessibilityAction(android.view.View host, int action, Bundle args) {
         ...
         * <p>
         * The default implementation behaves as
         * {@link android.view.View#sendAccessibilityEventUnchecked(AccessibilityEvent)
         ...
         */
        public void sendAccessibilityEventUnchecked(android.view.View host, AccessibilityEvent event) {
            host.sendAccessibilityEventUncheckedInternal(event);
        }

        /**
         * Dispatches an {@link AccessibilityEvent} to the host {@link android.view.View} first and then
         ...
         */
        public boolean dispatchPopulateAccessibilityEvent(android.view.View host, AccessibilityEvent event) {
         ...
         * <p>
         * The default implementation behaves as
         * {@link android.view.View#onPopulateAccessibilityEvent(AccessibilityEvent)
         ...
         */
        public void onPopulateAccessibilityEvent(android.view.View host, AccessibilityEvent event) {
         ...
         * <p>
         * The default implementation behaves as
         * {@link android.view.View#onInitializeAccessibilityEvent(AccessibilityEvent)
         ...
         */
        public void onInitializeAccessibilityEvent(android.view.View host, AccessibilityEvent event) {
         ...
         */
        public void onInitializeAccessibilityNodeInfo(android.view.View host, AccessibilityNodeInfo info) {
         ...
         * <p>
         * The default implementation behaves as
         * {@link ViewGroup#onRequestSendAccessibilityEvent(android.view.View, AccessibilityEvent)
         ...
         *
         * @see ViewGroup#onRequestSendAccessibilityEvent(android.view.View, AccessibilityEvent)
         *      ViewGroup#onRequestSendAccessibilityEvent(View, AccessibilityEvent)
         */
        public boolean onRequestSendAccessibilityEvent(ViewGroup host, android.view.View child,
         ...
         * @see AccessibilityNodeProvider
         */
        public AccessibilityNodeProvider getAccessibilityNodeProvider(android.view.View host) {
            return null;
        }
         ...
         * <p>
         * The default implementation behaves as
         * {@link android.view.View#createAccessibilityNodeInfo() View#createAccessibilityNodeInfo()} for
         * the case of no accessibility delegate been set.
         * </p>
         * @return A populated {@link AccessibilityNodeInfo}.
         *
    ...
    private class MatchIdPredicate implements Predicate<android.view.View> {
        public int mId;

        @Override
        public boolean apply(android.view.View view) {
            return (view.mID == mId);
        }
    }

    private class MatchLabelForPredicate implements Predicate<android.view.View> {
    ...
    private boolean inLiveRegion() {
        ...
        ViewParent parent = getParent();
        while (parent instanceof android.view.View) {
            if (((android.view.View) parent).getAccessibilityLiveRegion()
    ...
    private static void dumpFlags() {
        ...
        try {
            for (Field field : android.view.View.class.getDeclaredFields()) {
